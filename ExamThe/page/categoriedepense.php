               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <div class="col-lg-12">
                              <div class="card">
                                 <div class="card-body">
                                   <h5 class="card-title">Inserer d'une catégorie de dépenses</h5>
                                     <form action="../traitement/traitementAdmin.php" method="post" class="my-4 p-4 border">
                                         <div class="mb-3 row">
                                             <label for="inputText" class="col-sm-2 col-form-label">Nom de la catégorie</label>
                                             <div class="col-sm-10">
                                                 <input type="text" class="form-control" name="nomcat" placeholder="Entrez le nom de la catégorie" required>
                                             </div>
                                         </div>
