               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <div class="col-lg-12">
                              <div class="card">
                                 <div class="card-body">
                                   <h5 class="card-title">Inserer une parcelle</h5>
                                   <form action="../traitement/traitementAdmin.php" method="post" class="my-4 p-4 border">
                                        <input type="hidden" name="link" value="1">
                                         <div class="mb-3 row">
                                             <label for="inputText" class="col-sm-2 col-form-label">Numero de parcelle</label>
                                             <div class="col-sm-10">
                                                 <input type="text" class="form-control" name="numero" placeholder="Entrez le numero de la parcelle" required>
                                             </div>
                                         </div>
                                         <div class="mb-3 row">
                                             <label for="inputText" class="col-sm-2 col-form-label">Surface de la parcelle</label>
                                             <div class="col-sm-10">
                                                <input type="text" class="form-control" name="surface" placeholder="Entrez la surface de la parcelle" required>
                                             </div>
                                         </div>
                                         <div class="mb-3 row">
                                            <label for="inputText" class="col-sm-2 col-form-label">Variété de parcelle</label>
                                            <div class="col-sm-10">
                                          <select class = "form-select" aria-label="Default select example" name="variete">
                                             <?php for($i=0;$i<count($tab);$i++){?>
                                          <option value="<?php echo($tab[$i]['id']);?>"><?php echo($tab[$i]['nom']);?></option>   
                                       <?php } ?>
                                       </select>   
                                       </div>
                                        </div>
