                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="#elements"  data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-table purple_color2"></i> <span>Parcelle</span></a>
                        <ul class="collapse list-unstyled" id="elements">
                           ...
                           <li><a href="gestioparcelle.php">> <span>Gestion des parcelles</span></a></li>
                        </ul>
                     </li>
                     <li>
               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <div class="col-lg-12">
                              <div class="card">
                                 <div class="card-body">
                                   <h5 class="card-title">Inserer un cueilleur</h5>
                                     <form action="../traitement/traitementAdmin.php" method="post" class="my-4 p-4 border">
                                        <input type="hidden" name="link" value="2">
                                         <div class="mb-3 row">
                                             <label for="inputText" class="col-sm-2 col-form-label">Nom du cueilleur</label>
                                             <div class="col-sm-10">
                                                 <input type="text" class="form-control" name="nom" placeholder="Entrez le nom du cueilleur" required>
                                             </div>
                                         </div>
                                         <div class="mb-3 row">
                                             <label for="inputText" class="col-sm-2 col-form-label">Genre du cueilleur</label>
                                             <div class="col-sm-10">
                                                <input type="text" class="form-control" name="genre" placeholder="Entrez le genre " required>
                                             </div>
                                         </div>
                                         <div class="mb-3 row">
                                            <label for="inputText" class="col-sm-2 col-form-label">Date de naissance</label>
                                            <div class="col-sm-10">
                                               <input type="date" class="form-control" name="dtn" placeholder="Entrez la date de naissance" required>
                                            </div>
                                        </div>
                                         <div class="mb-3 row">
