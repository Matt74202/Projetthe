               ...
               <div class="midde_cont">
                  <div class="container-fluid">
                     ...
                     <div class="col-lg-12">
                        <div class="card">
                           <div class="card-body">
                              <h5 class="card-title">Inserer un salaire</h5>
                              <form action="../traitement/traitementAdmin.php" method="post" class="my-4 p-4 border">
                                 <input type="hidden" name="link" value="4">
                                 <div class="mb-3 row">
                                    <label for="inputText" class="col-sm-2 col-form-label">Salaire du cueilleur</label>
                                    <div class="col-sm-10">
                                       <input type="text" class="form-control" name="salaire" placeholder="Entrez le salaire du cueilleur" required>
                                    </div>
                                 </div>
